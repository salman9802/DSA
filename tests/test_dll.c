...
MunitResult test_dll_insert_at_tail() {
    int i1 = 1, i2 = 2, i3 = 3;
    object_t *o1, *o2, *o3;
    ...
    munit_assert_int(head->next->next->prev->data->value.v_int, ==, i2);
    munit_assert_int(head->next->next->prev->prev->data->value.v_int, ==, i1);
...
MunitResult test_dll_insert_at_head() {
    int i1 = 1, i2 = 2, i3 = 3;
    object_t *o1, *o2, *o3;
    o1 = new_int_object(i1);
    o2 = new_int_object(i2);
    ...
    dll_node_t *head = NULL;
    dll_insert_at_head(&head, o1);
    dll_insert_at_head(&head, o2);
    dll_insert_at_head(&head, o3);

    munit_assert_int(head->data->value.v_int, ==, i3);
    munit_assert_int(head->next->data->value.v_int, ==, i2);
    munit_assert_int(head->next->next->data->value.v_int, ==, i1);
    munit_assert_int(head->next->next->prev->data->value.v_int, ==, i2);
    munit_assert_int(head->next->next->prev->prev->data->value.v_int, ==, i3);
...
MunitResult test_dll_remove_at_tail() {
    int i1 = 1, i2 = 2, i3 = 3;
    object_t *o1, *o2, *o3;
    o1 = new_int_object(i1);
    o2 = new_int_object(i2);
    ...
    munit_assert_ptr(dll_remove_at_tail(&head)->data, ==, o3);
    munit_assert_ptr(dll_remove_at_tail(&head)->data, ==, o2);
    munit_assert_ptr(dll_remove_at_tail(&head)->data, ==, o1);
    
    return MUNIT_OK;
}

MunitResult test_dll_remove_at_head() {
    int i1 = 1, i2 = 2, i3 = 3;
    object_t *o1, *o2, *o3;
    o1 = new_int_object(i1);
    o2 = new_int_object(i2);
    ...
    munit_assert_ptr(dll_remove_at_head(&head)->data, ==, o1);
    munit_assert_ptr(dll_remove_at_head(&head)->data, ==, o2);
    munit_assert_ptr(dll_remove_at_head(&head)->data, ==, o3);
...
MunitSuite *test_dll_suite() {
    ...
    static MunitTest dll_tests[] = {
    {
        "/test_dll_insert_at_tail", /* name */
        test_dll_insert_at_tail, /* test */
        NULL, /* setup */
        NULL, /* tear_down */
    ...
    {
        "/test_dll_insert_at_head", /* name */
        test_dll_insert_at_head, /* test */
        NULL, /* setup */
        NULL, /* tear_down */
        MUNIT_TEST_OPTION_NONE, /* options */
        NULL /* parameters */
    ...
    {
        "/test_dll_remove_at_tail", /* name */
        test_dll_remove_at_tail, /* test */
        NULL, /* setup */
        NULL, /* tear_down */
        MUNIT_TEST_OPTION_NONE, /* options */
        NULL /* parameters */
    ...
    {
        "/test_dll_remove_at_head", /* name */
        test_dll_remove_at_head, /* test */
        NULL, /* setup */
        NULL, /* tear_down */
        MUNIT_TEST_OPTION_NONE, /* options */
        NULL /* parameters */
